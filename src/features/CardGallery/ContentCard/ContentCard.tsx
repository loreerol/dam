...
import { formatDate, formatSnakeCase, getFileExtention, getFileType } from "./utils";
  ...
  return (
    ...
    <Card>
      ...
      >
        ...
        <Typography variant="body2">Created: {cardData.formatedCreatedDate}</Typography>
        <Typography variant="body2">Modified: {cardData.formatedModiedDate}</Typography>
      </CardContent>
      <CardActions
    ...
    <DownloadModal modalOpen={modalOpen} toggleModal={toggleModal} image={item.preview} data={cardData}/>
    </>
  );
};
